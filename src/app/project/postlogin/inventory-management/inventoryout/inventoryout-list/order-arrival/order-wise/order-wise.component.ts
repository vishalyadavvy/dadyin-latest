...
export class OrderWiseComponent implements OnInit {
  ...
  public orderWiseHeader = [
    ...
    { name: 'SALES ORDER', prop: 'saleOrderId', sortable: true },
    { name: 'PRODUCTS', prop: 'productCount', sortable: true },
    { name: 'DOCK #', prop: 'dockNumber', sortable: true },
    { name: 'REQ.BY', prop: 'expectedByDate', sortable: true },
    { name: 'ASSIGN TO', prop: 'verifierName', sortable: true },
    ...
    { name: 'INCOTERM', prop: 'incoTermId', sortable: true },
  ...
  editRecord(event): void {
    ...
    if (!event.data.inventoryId && event?.data?.id) {
      this.router.navigateByUrl(
        'home/inventory-management/inventoryout/order-wise-create-inventory/' +
          event.data.id
      );
    } else {
      this.router.navigateByUrl(
        'home/inventory-management/inventoryout/order-wise-update-inventory/' +
